...
public class QuickTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        array_list = dbActivity.getDataRandom();
        ...
        editor.putInt("isMock", 2); // 1 : mock , 2:Quick
        editor.commit();
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(getArguments().getInt(ARG_SECTION_NUMBER)!= 16 && getArguments().getInt(ARG_SECTION_NUMBER)!= 17) {

                View rootView = inflater.inflate(R.layout.fragment_quick_test, container, false);
                QuickTestFragment quickTestFragment = new QuickTestFragment();
                quickTestFragment.setQuesNAns(mViewPager, getActivity(), rootView, getArguments().getInt(ARG_SECTION_NUMBER), (Table) getArguments().getSerializable("TABLE"));
                return rootView;
            }
