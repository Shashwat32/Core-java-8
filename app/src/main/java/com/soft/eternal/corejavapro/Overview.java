        ...
        extends Fragment
{
    ...
    public static Overview newInstance(String paramString1, String paramString2)
    {
        ...
        localOverview.setArguments(localBundle);
    ...
    {
        return paramLayoutInflater.inflate(R.layout.fragment_overview, paramViewGroup, false);
    }
